...
void MI_UI_THEME_PRESET::Loop() {
    set_current_item(std::to_underlying(gui::theme::preset()));
}
...
void MI_UI_ACCENT_COLOR::Loop() {
    set_current_item(std::to_underlying(gui::theme::accent()));
    set_enabled(gui::theme::preset() == gui::theme::ThemePreset::custom);
}
...
void MI_UI_BACKGROUND_COLOR::Loop() {
    set_current_item(std::to_underlying(gui::theme::background()));
    set_enabled(gui::theme::preset() == gui::theme::ThemePreset::custom);
}
